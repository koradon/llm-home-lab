...
description: >-
  ...
  scenarios in docs/specs/<slug>.feature when behavior should be acceptance-tested.
---
...
3. For accepted behavior, add or update a sibling Gherkin file: `docs/specs/<spec-slug>.feature` using `docs/llm/templates/acceptance.feature`.
