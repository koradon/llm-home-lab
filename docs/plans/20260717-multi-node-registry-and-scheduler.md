...
- Spec: [multi-node-registry-and-scheduler](../specs/20260717-multi-node-registry-and-scheduler.md)
- Depends on: [policy-routing-engine](../specs/20260717-policy-routing-engine.md) and
...
- Depends on: [failover-and-health-policy](../specs/20260717-failover-and-health-policy.md) and
