...
- Spec: [context-cache-and-compaction](../specs/context-cache-and-compaction.md)
- Depends on: [session-manager-core](../specs/session-manager-core.md) and
  [`state/models.py`](../../src/llm_home_lab/state/models.py) (`Session`, `StoredMessage`,
  `Summary` — the shapes this module consumes)
- Related: [failover-and-health-policy](../specs/failover-and-health-policy.md) (the failover-
