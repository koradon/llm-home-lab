...
- Spec: [tool-state-abstraction](../specs/tool-state-abstraction.md)
- Depends on: [session-manager-core](../specs/session-manager-core.md) (`SessionNotFoundError`,
  the shared `sessions` table)
- Mirrors: [workspace-state-capture](../specs/workspace-state-capture.md) (same passive-store
  architecture)
