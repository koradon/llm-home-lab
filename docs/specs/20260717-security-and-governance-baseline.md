...
Keep scenarios in a sibling Gherkin file: `docs/specs/features/20260717-security-and-governance-baseline.feature`.
...
- Module: [`state/tool_state_manager.py`](../../src/llm_home_lab/state/tool_state_manager.py) —
  ...
  parameter.
- Spec: [tool-state-abstraction](20260717-tool-state-abstraction.md) — confirms `ToolStateManager` stays
  unwired from HTTP; this spec does not change that.
- Spec: [multi-node-registry-and-scheduler](20260717-multi-node-registry-and-scheduler.md) — the
  `/v1/nodes/*` endpoints this spec authorizes.
- Plan: (to be written) `docs/plans/20260717-security-and-governance-baseline.md` — will scope the
...
- Issue: `.plan/milestones/m4-production-hardening/issues/issue-003-security-and-governance-baseline.md`
  (#11)
- Acceptance: `docs/specs/features/20260717-security-and-governance-baseline.feature`
