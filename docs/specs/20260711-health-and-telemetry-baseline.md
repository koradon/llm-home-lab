...
Keep scenarios in a sibling Gherkin file: `docs/specs/features/20260711-health-and-telemetry-baseline.feature`.

## Related

- Plan: [orchestrator-program](../plans/20260711-orchestrator-program.md) (M1 — health and telemetry
  baseline)
- Spec: [openai-compatible-api-gateway](20260711-openai-compatible-api-gateway.md) (gateway this health
  check attaches to)
- Spec: [lmstudio-backend-adapter](20260711-lmstudio-backend-adapter.md) (backend whose health this
  reports)
- Acceptance: `docs/specs/features/20260711-health-and-telemetry-baseline.feature`
