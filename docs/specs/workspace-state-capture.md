...
Keep scenarios in a sibling Gherkin file: `docs/specs/workspace-state-capture.feature`.

## Related

- Plan: [orchestrator-program](../plans/orchestrator-program.md) (M2 — workspace state capture)
...
- Acceptance: `docs/specs/workspace-state-capture.feature`
