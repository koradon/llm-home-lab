...
Keep scenarios in a sibling Gherkin file: `docs/specs/policy-routing-engine.feature`.

## Related

- Plan: [policy-routing-engine](../plans/policy-routing-engine.md)
- Plan: [orchestrator-program](../plans/orchestrator-program.md) (M3 — policy-based routing
  engine)
- Spec: [session-manager-core](session-manager-core.md) (the `session_id` sticky routing keys
  off)
...
- Issue: `.plan/milestones/m3-routing-and-reliability/issues/issue-001-policy-routing-engine.md`
  (#6)
- Acceptance: `docs/specs/policy-routing-engine.feature`
