...
Keep scenarios in a sibling Gherkin file: `docs/specs/session-manager-core.feature`.

## Related

- Plan: [orchestrator-program](../plans/orchestrator-program.md) (M2 — session manager core)
- ADR: [0002-sqlite-for-session-storage](../adr/0002-sqlite-for-session-storage.md)
- Acceptance: `docs/specs/session-manager-core.feature`
